            ...
            <ul className="menu">
                ...
                {user?.user_metadata?.role == 'admin' && (
                    <>
                        ...
                        <li><Link href={"/admin/faqs/list"}>FAQs</Link></li>
                    </>
                )}

                {user?.user_metadata?.role == 'user' && (
                    <>
                        <li><Link href={"/user/events/list"}>Events</Link></li>
                        <li><Link href={"/user/members/list"}>Members</Link></li>
                        <li><Link href={"/user/transactions/list"}>Transactions</Link></li>
                    </>
                )}
            </ul>
        </>
